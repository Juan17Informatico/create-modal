...
`,y=o=>{if(!o)throw new Error("No hay ID para crear contenedor");const t=document.createElement("div");t.setAttribute("id",o),t.setAttribute("class","modal-container hidden");const r=document.createElement("div");r.setAttribute("class","modal-btn-container-close");const s=document.createElement("button");s.setAttribute("id",`cerrar-${o}`);const{svgIcon:e,pathIcon:n}=F();e.appendChild(n),s.appendChild(e),r.appendChild(s),t.appendChild(r);const i=document.createElement("div");return i.setAttribute("class","modal-contain"),t.appendChild(i),[t,i,s]},F=()=>{const o=document.createElementNS("http://www.w3.org/2000/svg","svg");o.setAttribute("xmlns","http://www.w3.org/2000/svg"),o.setAttribute("width","24"),o.setAttribute("height","24"),o.setAttribute("fill","currentColor"),o.classList.add("bi","bi-x-lg"),o.setAttribute("viewBox","0 0 16 16");const t=document.createElementNS("http://www.w3.org/2000/svg","path");return t.setAttribute("d","M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z"),{pathIcon:t,svgIcon:o}},L=({id:o,title:t,icon:r,text:s="",form:e=void 0,closeBtn:n=void 0},i)=>{const m=document.createElement("h2"),h=document.createElement("img"),f=document.createElement("p"),a=document.createElement("button");f.innerText=s,m.innerText=t,h.src=r,a.innerText=n,a.setAttribute("id",o),i.append(h,m,f);const u=document.createElement("button"),p=document.createElement("form");return e&&(p.setAttribute("id",e.id),e.preguntas.forEach(l=>{const v=document.createElement("input");v.tpye=l.typeInput,v.placeholder="...",v.name=l.name,v.id=l.id;const g=document.createElement("label");g.innerText=l.label,p.append(g,v)}),u.setAttribute("class","btn-modal"),u.type=e.typeSubmit,u.innerText="Enviar",p.appendChild(u),i.appendChild(p)),i.appendChild(a),[a,u,p]},C={success:{id:"success",title:"Guardado",icon:"/create-modal/img/check.png",text:"Mensaje enviado con exito",closeBtn:"Cerrar",form:void 0},error:{id:"error",title:"Error",icon:"/create-modal/img/error.png",text:"Error al enviar solicitud",closeBtn:"Cerrar",form:void 0},quiz:{id:"quiz",title:"Cuestionario",icon:"/create-modal/img/question.png",text:"Responde lo siguiente:",closeBtn:"Cerrar",form:{id:"abc",preguntas:[{label:"¿Cuál es tu nombre?",typeInput:"text",name:"name",id:"name"},{label:"¿Cuáles son tus apellidos?",typeInput:"text",name:"lastname",id:"lastname"},{label:"¿Cuantos años tienes?",typeInput:"number",name:"age",id:"age"}],typeSubmit:"submit"}},info:{id:"info",title:"Información",icon:"/create-modal/img/info.png",text:"Esto es un modal informativo",closeBtn:"Cerrar",form:void 0}},N=o=>{o.innerHTML=z;const t=document.querySelector("#modal-containers"),r=document.querySelector(".overlay"),s=document.getElementById("btn-success"),e=document.getElementById("btn-error"),n=document.getElementById("btn-form"),i=document.getElementById("btn-info"),[m,h,f]=y("success"),[a,u,p]=y("error"),[l,v,g]=y("quiz"),[E,B,I]=y("info");t.appendChild(m),t.appendChild(a),t.appendChild(l),t.appendChild(E);const[M]=L(C.success,h),[x]=L(C.error,u),[A,S,T]=L(C.quiz,v),[k]=L(C.info,B),w=c=>{c.classList.remove("hidden"),r.classList.remove("hidden")},d=c=>{c.classList.add("modal-closing"),c.addEventListener("animationend",()=>{c.classList.add("hidden"),r.classList.add("hidden"),c.classList.remove("modal-closing")},{once:!0})};s.addEventListener("click",()=>w(m)),e.addEventListener("click",()=>w(a)),n.addEventListener("click",()=>w(l)),i.addEventListener("click",()=>w(E)),f.addEventListener("click",()=>d(m)),p.addEventListener("click",()=>d(a)),g.addEventListener("click",()=>d(l)),I.addEventListener("click",()=>d(E)),M.addEventListener("click",()=>d(m)),x.addEventListener("click",()=>d(a)),A.addEventListener("click",()=>d(l)),k.addEventListener("click",()=>d(E)),S.addEventListener("click",c=>{c.preventDefault();const b=document.getElementById("name").value,O=document.getElementById("lastname").value,q=document.getElementById("age").value;alert(`Hola ${b} ${O}, 
